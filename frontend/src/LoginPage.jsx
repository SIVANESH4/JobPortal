...
<form action={formAction} className="mt-6 space-y-4">
    ...
    <div>
        ...
        <input type="name" name= "username" placeholder="Enter your username" className="mt-1 w-full rounded border border-gray-300 px-3 py-2
    ...
    <button type="submit"  disabled={isPending} className="w-full bg-blue-700 hover:bg-blue-800
